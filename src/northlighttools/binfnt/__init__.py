...
@app.command(
    name="decompile", help="Decompile .binfnt file to editable JSON and bitmap(s)"
)
def cmd_decompile(
...
@app.command(name="compile", help="Compile JSON and bitmap(s) to .binfnt file")
def cmd_compile(
    input_file: Annotated[
        Path,
        typer.Argument(
